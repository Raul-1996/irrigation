...
class ProgramRunnerMixin(WeatherMixin):
                    ...
                    if not okv:
                        try:
                            ...
                            _uzs(
                                ...
                                audit_reason="runner_start_fallback",
                                db=self.db,
                            )
    ...
    def start_group_sequence(self, group_id: int, override_duration: int | None = None):
    ...
    def _run_group_sequence(self, group_id: int, zone_ids: list[int], override_duration: int | None = None):
            ...
            for zone_id in zone_ids:
                ...
                try:
                    ...
                    _uzs(
                        ...
                        audit_reason="runner_testing_start",
                        db=self.db,
                    )
                except (sqlite3.Error, OSError, ImportError):
                    logger.exception(
