...
class TestAuditUIEvent:
    ...
    def test_records_click(self, admin_client):
        ...
        resp = admin_client.post(
            "/api/audit/ui",
            data=json.dumps({"action": "zone_start_click", "target": "zone:5", "context": {"reason": "manual"}}),
            content_type="application/json",
        )
    ...
    def test_handles_empty_body(self, admin_client):
        ...
        resp = admin_client.post("/api/audit/ui", data="{}", content_type="application/json")
        assert resp.status_code in (200, 204)
    ...
    def test_strips_password_from_context(self, client, admin_client):
        ...
        resp = client.post(
            "/api/audit/ui",
            data=json.dumps({"action": "login_attempt", "context": {"username": "u", "password": "p4ssw0rd"}}),
            content_type="application/json",
        )
        assert resp.status_code in (200, 204)
