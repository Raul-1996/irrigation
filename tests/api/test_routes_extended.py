...
class TestZonePhotoEndpoints:
    def test_upload_no_file(self, admin_client, app):
        ...
        resp = admin_client.post(f"/api/zones/{z['id']}/photo", content_type="multipart/form-data")
...
class TestMqttProbe:
    def test_probe_server(self, admin_client, app):
        ...
        resp = admin_client.post(f"/api/mqtt/{s['id']}/probe", content_type="application/json")
...
class TestSystemAPIExtended:
    ...
    def test_health_cancel_group(self, admin_client, app):
        ...
        resp = admin_client.post(f"/api/health/group/{g['id']}/cancel", content_type="application/json")
