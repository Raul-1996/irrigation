...
class TestZoneMqttStartOverride:
    ...
    def test_start_with_override_sets_planned_end_time(self, client, app):
        ...
        resp = client.post(
            f"/api/zones/{zone_id}/mqtt/start", data=json.dumps({"duration": 24}), content_type="application/json"
        )
    ...
    def test_start_without_override_uses_base(self, client, app):
        ...
        resp = client.post(f"/api/zones/{zone_id}/mqtt/start", content_type="application/json")
        assert resp.status_code == 200
...
class TestGroupStartOverride:
    ...
    def test_group_start_without_override_uses_base(self, client, app):
        ...
        client.post("/api/groups/1/start-from-first", content_type="application/json")
