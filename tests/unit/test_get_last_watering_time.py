...
class TestGetLastWateringTime:
    ...
    def test_aborted_run_excluded(self, test_db):
        ...
        with sqlite3.connect(test_db.db_path) as conn:
            conn.execute(
                "UPDATE zone_runs SET end_utc = ?, status = 'aborted' WHERE id = ?",
    ...
    def test_returns_most_recent_ok_run(self, test_db):
        ...
        assert test_db.get_last_watering_time(int(zone["id"])) == "2026-04-02 09:30:00"
    ...
    def test_non_meter_zone_returns_end_utc(self, test_db):
        ...
        assert test_db.get_last_watering_time(int(zone["id"])) == "2026-04-03 10:20:00"
    ...
    def test_per_zone_isolation(self, test_db):
        ...
        assert test_db.get_last_watering_time(int(z1["id"])) == "2026-04-01 09:15:00"
