...
class TestProgramConflicts:
    def test_no_conflict(self, test_db):
        ...
        conflicts = test_db.check_program_conflicts(program_id=None, time="18:00", zones=[2], days=[0])
    ...
    def test_time_overlap_conflict(self, test_db):
        ...
        conflicts = test_db.check_program_conflicts(program_id=None, time="06:10", zones=[z1["id"]], days=[0])
